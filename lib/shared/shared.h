/*
 * Declares shared utility functions and constants used across the
 * parser, optimizer, and executor modules.
 * Keeping these here avoids duplicating small helpers in every module
 * and keeps each module binary smaller on CP/M.
 *
