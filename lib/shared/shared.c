/*
 * Implements shared utility functions used across parser, optimizer,
 * and executor modules. All functions here are pure utilities with no
 * dependency on catalog layout or execution state.
 *
