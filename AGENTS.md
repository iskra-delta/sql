...
We are developing C11 code for 8-bit retro microcomputers.
...
- SDCC is used only after the code is working under GCC.
- The code must stay compatible with both GCC and SDCC.
...
- Use only C11 features that work in both GCC and SDCC.
...
- Run SDCC only after the GCC build works.
...
- The test approach should stay portable enough for future SDCC use.
